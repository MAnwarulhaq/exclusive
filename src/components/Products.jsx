...
const Products = ({ id, image, heading, newprice, oldprice, discount }) => {
  ...
  return (
      ...
      <div className="shadow rounded-lg  w-full  flex flex-col hover:shadow-lg hover:scale-105 duration-200">
  ...
  <div className="relative group bg-gray-200 w-full h-60 flex justify-center items-center p-2 rounded-t">
    ...
    <button
      onClick={handleaddtocart}
      className="absolute bottom-0 w-full bg-black text-white h-10 rounded-b font-semibold cursor-pointer block 
